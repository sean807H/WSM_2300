...
const initWashingmachineTime = () => {
    ...
    reservations.forEach((reservation) => {
        if(newReservation.date.getFullYear() == reservation.date.getFullYear() && newReservation.date.getMonth() == reservation.date.getMonth() && newReservation.date.getDate() == reservation.date.getDate()){
